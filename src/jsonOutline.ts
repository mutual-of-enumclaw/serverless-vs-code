...
export class JsonOutlineProvider implements vscode.TreeDataProvider<number> {
	...
	private tree: json.Node = null as any;
	private text: string = null as any;
	private editor: vscode.TextEditor = null as any;
	...
	constructor(private context: vscode.ExtensionContext) {
		...
		this.parseTree();
		this.autoRefresh = vscode.workspace.getConfiguration('jsonOutline').get('autorefresh') as boolean;
			...
			.then(value => {
				if (value !== null && value !== undefined) {
					this.editor.edit(editBuilder => {
						...
						if (((propertyNode as json.Node).parent as json.Node).type !== 'array') {
